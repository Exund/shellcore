...
public class AbilityHandler : MonoBehaviour
{
    ...
    public void Initialize(PlayerCore player, Ability[] displayAbilities = null)
    {
        ...
        for (int i = 0; i < 9; i++)
        {
            keybindList[i] = PlayerPrefs.GetString("AbilityHandler_abilityKeybind" + i, (i + 1).ToString());
        }
    ...
    public static void ChangeKeybind(int index, string val)
    {
        ...
        if (instance.displayAbs == null)
        {
            instance.Initialize(instance.core);
        }
        else
        {
            instance.Initialize(instance.core, instance.displayAbs);
        }
    }
